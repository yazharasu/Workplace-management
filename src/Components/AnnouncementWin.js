...
export default function AnnouncementWin( {setAnWin} ) {
    ...
    const submitHandler = async (e) => {
        ...
        if (togglestatus===1) {
            ...
            await axios.post( '/api/announcements/announcement', annoucDetails)
            ...
            await axios.post( '/api/announcements/event', annoucDetails)
                .then( (res) => {console.log(res.status); setAnnoucDetails({}) } )
            ...
            await axios.post( '/api/announcements/reminder', annoucDetails)
                .then( (res) => {console.log(res.status); setAnnoucDetails({}) } )
        }
    }
